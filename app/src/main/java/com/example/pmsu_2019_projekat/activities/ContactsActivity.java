...
public class ContactsActivity extends AppCompatActivity implements
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_contacts) {
            ...
            Intent c = new Intent(ContactsActivity.this, ContactsActivity.class);
            startActivity(c);
        } else if (id == R.id.nav_emails) {
            Intent d = new Intent(ContactsActivity.this, FoldersActivity.class);
            startActivity(d);
        } else if (id == R.id.nav_settings) {
            Intent f = new Intent(ContactsActivity.this, SettingsActivity.class);
            startActivity(f);
        }
